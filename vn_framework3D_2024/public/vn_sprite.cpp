...
//静的共通データ
ID3D12PipelineState *vnSprite::pPipelineState = NULL;	//パイプラインステート
ID3D12PipelineState* vnSprite::pPipelineState_Add = NULL;	//パイプラインステート(加算合成)
ID3D12Resource* vnSprite::constBuff = NULL;	//定数バッファ
